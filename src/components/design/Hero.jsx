...
export const BottomLine = () => {
  return (
    <>
      <div className="hidden absolute top-[48.25rem] left-10 right-10 h-0.25 bg-n-6 pointer-events-none xl:block" />

      <PlusSvg className="hidden absolute top-[47.9375rem] left-[2.1875rem] z-2 pointer-events-none xl:block" />

      <PlusSvg className="hidden absolute top-[47.9375rem] right-[2.1875rem] z-2 pointer-events-none xl:block" />
    </>
  );
};
...
export const BackgroundCircles = ({ parallaxRef }) => {
  ...
  return (
    <div className="absolute -top-[28.9rem] left-1/2 w-[78rem] aspect-square border border-n-2/5 rounded-full -translate-x-1/2 md:-top-[38.5rem] xl:-top-[30rem]">
      <Rings />
